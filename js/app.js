(() => {
    ...
    if (document.getElementById("count2")) {
        var count2Elem = document.getElementById("count2");
        document.getElementById("price2");
        var total2Elem = document.getElementById("total2");
        var plus2Elem = document.getElementById("plus2");
        var minus2Elem = document.getElementById("minus2");
        var count2 = 1;
        var price2 = 1500;
        function updatePrice2() {
            total2Elem.innerHTML = count2 * price2;
        }
        plus2Elem.addEventListener("click", (function() {
            count2++;
            count2Elem.innerHTML = count2;
            updatePrice2();
        }));
        minus2Elem.addEventListener("click", (function() {
            if (count > 1) {
                count2--;
                count2Elem.innerHTML = count2;
                updatePrice2();
